...
if ((rc_values[CH14]>1750)){rc_values[CH14]=2000;}
 Serial.print("ch1="); Serial.print( rc_values[CH1]);
 Serial.print("ch2="); Serial.print( rc_values[CH2]);
  Serial.print("ch3="); Serial.print( rc_values[CH3]);
  Serial.print("ch4="); Serial.print( rc_values[CH4]);
  Serial.print("ch5="); Serial.print( rc_values[CH5]);
   Serial.print("ch6="); Serial.print( rc_values[CH6]);
  Serial.print("ch7="); Serial.print( rc_values[CH7]);
  Serial.print("ch8="); Serial.print( rc_values[CH8]);
   Serial.print("ch9="); Serial.print( rc_values[CH9]);
  Serial.print("ch10="); Serial.print( rc_values[CH10]);

  Serial.print("ch11="); Serial.print( rc_values[CH11]);
  Serial.print("ch12="); Serial.print( rc_values[CH12]);
   Serial.print("ch13="); Serial.print( rc_values[CH13]);
...
if (RC_teller ==0){ 
  ...
  if(z==1){
  if ((Blt>7140)&& (Blt<7220)){digitalWrite(51, HIGH);digitalWrite(53, LOW); digitalWrite(52, HIGH);digitalWrite(50, LOW);}  // B vooruit //A vooruit
  if ((Blt>7060)&&(Blt<7104)){digitalWrite(50, HIGH);digitalWrite(52, LOW); digitalWrite(53, HIGH);digitalWrite(51, LOW);} //alles stop
 
  }else if (z==2){ 
 if ((Blt>6000)&&(Blt<6250)){v=Blt;}
 if ((Blt>7000)&&(Blt<7250)){w=Blt;}
  if ((v>6060)&&(v<6140)&& (w>7060)&& (w<7140)){digitalWrite(52, HIGH);digitalWrite(53, HIGH); digitalWrite(50, LOW);digitalWrite(52, LOW);  v=0;w=0;}  //A vooruit    // B achteruit
  if ((v>6140)&&(v<6221)&& (w>7060)&& (w<7140)){digitalWrite(52, LOW);digitalWrite(50,HIGH); digitalWrite(53, LOW);digitalWrite(51, HIGH);  v=0;w=0;}     //B vooruit    // A achteruit
  if ((v>6060)&&(v<6140)&& (w>7140)&& (w<7221)){digitalWrite(52, HIGH);digitalWrite(53, HIGH); digitalWrite(50, LOW);digitalWrite(52, LOW);  v=0;w=0;}  //A vooruit  // B achteruit
  if ((v>6140)&&(v<6221)&& (w>7140)&& (w<7221)){digitalWrite(52, LOW);digitalWrite(50,HIGH); digitalWrite(53, LOW);digitalWrite(51, HIGH);  v=0;w=0;}     //B vooruit    // A achteruit
...
Serial.print("V= ");Serial.print(v);Serial.print(" w= ");Serial.println(w);
  ...
  if ((Blt==7140)){   digitalWrite(52, LOW); digitalWrite(50, LOW);MotorSpeed1=0;digitalWrite(51, LOW);digitalWrite(53, LOW);MotorSpeed2=0;MotorSpeed1= 0;}  //A stop 
  }
if (z==0){
  //--------------------knoppen---app--------------------------------
...
if(z==0){
   //--------------knoppen-app--------------
if ((Blt==118)||(Blt==116)||(Blt==119)){digitalWrite(46, LOW); digitalWrite(47, LOW);} //stop kopschroef
if ((Blt==124)||(Blt==121)||(Blt==122)){digitalWrite(48, LOW); digitalWrite(49, LOW);}//stop hekschroef
if (Blt==117){digitalWrite(46, HIGH); digitalWrite(47,LOW);}// kopschroef linksom
if (Blt==115){digitalWrite(46, LOW); digitalWrite(47, HIGH);}//kopschroef rechts
if (Blt==120){digitalWrite(48, HIGH); digitalWrite(49, LOW);}//hekschroef
if (Blt==123){digitalWrite(48, LOW); digitalWrite(49, HIGH);}//hekschroef
...
if ((w>9060)&&(w<9140)&&(v>8060)&&(v<8140)){digitalWrite(46, HIGH); digitalWrite(47,LOW);digitalWrite(48, LOW); digitalWrite(49, LOW);v=0;w=0;}// kopschroef linksom
if ((w>9060)&&(w<9140)&&(v>8140)&&(v<8221)){digitalWrite(46, LOW); digitalWrite(47, HIGH);digitalWrite(48, LOW); digitalWrite(49, LOW);v=0;w=0;}//kopschroef rechts
if ((w>9140)&&(w<9221)&&(v>8060)&&(v<8140)){digitalWrite(48, HIGH); digitalWrite(49, LOW);digitalWrite(46, LOW); digitalWrite(47,LOW);v=0;w=0;}//hekschroef
if ((w>9140)&&(w<9221)&&(v>8140)&&(v<8221)){digitalWrite(48, LOW); digitalWrite(49, HIGH);digitalWrite(46, LOW); digitalWrite(47,LOW);v=0;w=0;}//hekschroef

 if ((Blt >9060)&&(Blt <9140)) {MotorSpeed3= map (Blt,9150,9060,255,60); MotorSpeed4 = MotorSpeed3;}  // slider motor A
   
else if ((Blt >9140)&&(Blt <9220)) { MotorSpeed3= map (Blt,9150,9220,60,255); MotorSpeed4 = MotorSpeed3;}   // slider motor A

else if (Blt==9140) {   MotorSpeed3= 0;  MotorSpeed4 = MotorSpeed3;digitalWrite(48, LOW); digitalWrite(49, LOW);digitalWrite(46, HIGH); digitalWrite(47,LOW);v=0;w=0;} 
}
...
if(z>0){
//--------------Joystick-app--------------
if((Blt>6140)&&(Blt<6221)){servoVal= map(Blt,6140,6220,90,0);}  // sturen met beide motoren knop middenstand
if((Blt>6060)&&(Blt<6140)){servoVal= map(Blt,6140,6060,90,180);}  // sturen met beide motoren knop middenstand
